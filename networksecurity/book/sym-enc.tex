...
\begin{itemize}
	\bitem{DHE (Diffie-Hellman Effimero)}utilizza chiavi Diffie-Hellman diverse e temporanee per ogni sessione.
...
\begin{enumerate}
	...
	\begin{itemize}
		\bitem{Sinonimi}PFS è spesso chiamato semplicemente Forward Secrecy (FS) o Public-Key Forward Secrecy (PFS) quando applicato a protocolli a chiave pubblica.
