...
\begin{itemize}
	\bitem{Verifica dell'integrità dei dati}un hash (spesso chiamato \textit{checksum}) viene calcolato su un file prima della trasmissione/memorizzazione ricalcolato dopo. Se i due hash coincidono, il file è integro. 
